...
public class TestUnstoreService {
    ...
    public void testUnstoreBarcode() {
        ...
        assertNull(unstoreService.unstoreBarcode("X"));
        ...
        assertEquals(item, unstoreService.unstoreBarcode(item.getBarcode()));
    ...
    public void testUnstoreBarcodes() {
        ...
        assertThat(unstoreService.unstoreBarcodes(list1)).isEmpty();
        ...
        assertThat(unstoreService.unstoreBarcodes(list2)).hasSameElementsAs(items);
    ...
    public void testEmpty() {
        ...
        assertThrows(EntityNotFoundException.class, () -> unstoreService.empty(li0));
        ...
        assertThat(unstoreService.empty(li1)).isEmpty();
        ...
        assertThat(unstoreService.empty(li2)).containsOnly(item);
